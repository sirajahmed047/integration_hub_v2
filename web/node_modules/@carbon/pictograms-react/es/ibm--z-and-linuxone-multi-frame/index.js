...
const IbmZAndLinuxoneMultiFrame = /*#__PURE__*/React.forwardRef(function IbmZAndLinuxoneMultiFrame(_ref, ref) {
  let {
    children,
    ...rest
  } = _ref;
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn(`The IbmZAndLinuxoneMultiFrame component has been deprecated and will be ` + `removed in the next major version of @carbon/icons-react.`);
    }
  }
