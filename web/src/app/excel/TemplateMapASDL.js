...
class TemplateMapASDL extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  handleLoad() {
    ...
    list.push(this.getJsonDataType1('organization_link', 'Organization Link'));
    list.push(this.getJsonDataType1('organization', 'Organization'));
    list.push(
      this.getJsonDataType3('location', 'Location', this.state.locations)
    );
    list.push(this.getJsonDataType2('location_ref', 'Location Ref'));
    list.push(this.getJsonDataType2('account_style', 'Account Style Caption'));
    list.push(this.getJsonDataType2('account_subtype', 'Account Subtype'));
    list.push(
    ...
    list.push(this.getJsonDataType2('account_reader', 'Account Reader'));
    list.push(
    ...
    list.push(
      this.getJsonDataType2('record_billing_type', 'Record Billing Type')
    );
    list.push(this.getJsonDataType2('record_subtype', 'Record Subtype'));
    list.push(
      this.getJsonDataType2('record_entry_method', 'Record Entry Method')
    );
    ...
    list.push(this.getJsonDataType2('total_cost', 'Total Cost'));
            ...
            <div className="fin-row">
              <div className="fin-column">
                <Button
                  ...
                  onClick={this.onClickIngestASDL}
                >
                  Ingest
                </Button>
              </div>
              <div className="fin-row">
                <div>
                  <span className="instruction-msg">
                    {this.props.resultIngestASDL &&
                      this.props.resultIngestASDL.msg}
                  </span>
                </div>
              </div>
            </div>
...
export default TemplateMapASDL;
